            ...
            <div class="navbar">
                ...
                <ul>
                    <div class="topnav" id="myTopnav">
                        ...
                        <li><a href="../PHP/tickets.php" target="_top">Tickets</a></li>
                        <li><a href="../PHP/animals.php" target="_top">Animals</a></li>
                        <li><a href="../PHP/about.php" target="_top">About</a></li>
                        <li><a href="../PHP/contact.php" target="_top">Contact Us</a></li>
